...
import { DevCoupon, DX, SaasAdmin } from '../../../app/models';
...
function Index(props) {
	...
	const goBack = () => {
		history.push(DX.admin.createPath(`/promotion/coupon/${id}/detail`));
	};
	...
	const handleSubmit = (value) => {
		const dataEdit = {
			...
			couponPricing: convertToArrObjForPricing(value.promotionGroup?.list),
			...
			couponPricingApply: convertToArrObjForPricing(value.pricingGroup?.list),
			pricingType: value.pricingGroup.type,
			couponAddons: convertToArrObj(value.addonGroup?.list, 'addonsId'),
