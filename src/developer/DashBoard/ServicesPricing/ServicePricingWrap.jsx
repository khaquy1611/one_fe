...
import { totalServicesByStatusApprove } from 'admin/DashBoard/dashboard-data/ServiceAndPricing/totalServiceByStatusApprove';
import { totalPricingByStatusApprove } from 'admin/DashBoard/dashboard-data/ServiceAndPricing/PricingStatusApprove';
import { totalSubcriptionByPricing } from 'admin/DashBoard/dashboard-data/ServiceAndPricing/TotalSubcriptionByPricing';
import { topRatedService } from 'admin/DashBoard/dashboard-data/ServiceAndPricing/TopRatedService';
import { newServiceRate } from 'admin/DashBoard/dashboard-data/ServiceAndPricing/newServiceRate';
import { services } from 'admin/DashBoard/dashboard-data/ServiceAndPricing/services';
import { serviceAverageRateData } from 'admin/DashBoard/dashboard-data/ServiceAndPricing/serviceAverageRateData';
